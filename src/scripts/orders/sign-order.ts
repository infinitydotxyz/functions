...
export async function signOrder(signer: Wallet, orderDescription: { nfts: ChainNFTs[], chainId: ChainId, isSellOrder: boolean, numItems: number, startPriceEth: number, endPriceEth: number, startTimeMs: number, endTimeMs: number }): Promise<CreateOrderDto> {
